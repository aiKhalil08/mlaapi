...
<body>
    ...
    <main>
        ...
        <p>
            Thanks for joining Mitiget Learning Academy! We're excited to welcome you to our community of passionate learners. To activate your account and unlock access to our extensive course library and events, please verify your email address.
            <br>
            Enter the verification code provided to complete the process:
        </p>

        
    
        <p><strong>Verification code: </strong>{{$otp_code}}</p>
    
    
        <p>
            This code will expire in 30 minutes. If you don't verify your email within this timeframe, please request a new code.
        </p>
    
        <p>Why verify your email?</p>

        <p>Verifying your email ensures you receive important updates about your account, course registrations, upcoming events, and special offers from Mitiget Learning Academy.</p>
