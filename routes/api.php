...
Route::middleware(['should_use:student-jwt', 'jwt_auth'])->group(function () {
    ...
    Route::post('/student/get_carted_course', [StudentController::class, 'get_carted_course']);
    ...
    Route::get('/student/renew-referral-code', [AffiliateController::class, 'create_referral_code']);
...
Route::get('/admin/fetch-affiliate/{code}', [AffiliateController::class, 'fetch_affiliate'])->middleware(['should_use:admin-jwt', 'jwt_auth']);
